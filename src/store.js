// store.js
import { configureStore } from '@reduxjs/toolkit'; // Creates the Redux store with the configureStore() function from @reduxjs/toolkit.
...
/**This code creates a global Redux store using the @reduxjs/toolkit
 * configureStore() function so *all components in the application*
 * can access the state managed by the avReducer(). */
...
export default configureStore({
  reducer: {
    ...
    meals: mealsReducer, // Step 4: Display meal items in the Conference.jsx component.
  },
});
